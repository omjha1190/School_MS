...
urlpatterns = [
    path('insert/student-attendance/', views.student_attendance, name="student_attendance"),
    path('manage/student-attendance/<int:section_id>/', views.manage_student_attendance, name="manage_student_attendance"),
    path('insert/teacher-attendance/', views.teacher_attendance, name="teacher_attendance"),
